...
import { SupportedContentEncodings, SupportedUrgency } from './web-push-constants.mjs';

import vapidHelper from './vapid-helper.mjs';
import encryptionHelper from './encryption-helper.mjs';
...
WebPushLib.prototype.generateRequestDetails = function (subscription, payload, options) {
	...
	if (options) {
		...
		if (options.contentEncoding) {
			if ((options.contentEncoding === SupportedContentEncodings.AES_128_GCM
